...
/// @author Daniel Jin
/// @title TokenAvgPrice1
contract TokenAvgPrice1 is OwnableUpgradeable {
    // Day Inforamtion
    struct DayInfo {
        uint256 price;
        uint256 totalPrice;
    ...
    function setDayPrice(uint8 mon, uint8 day, uint256 price) external isDateFormat(mon, day) {
    ...
    function getAvgPrice(uint8 fromMon, uint8 fromDay, uint8 toMon, uint8 toDay) public view isDateFormat(fromMon, fromDay) isDateFormat(toMon, toDay) returns(uint256) {
